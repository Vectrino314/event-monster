module.exports = {
  ...
  "content": {
    ...
    "files": [
      ...
      "./assets/**/*.scss",
      "./assets/**/*.css",
      "C:/Development/event-monster/frontend/src/components/**/*.{vue,js,ts}",
      "C:/Development/event-monster/frontend/src/layouts/**/*.vue",
      "C:/Development/event-monster/frontend/src/pages/**/*.vue",
      "C:/Development/event-monster/frontend/src/composables/**/*.{js,ts}",
      "C:/Development/event-monster/frontend/src/plugins/**/*.{js,ts}",
      "C:/Development/event-monster/frontend/src/App.{js,ts,vue}",
      "C:/Development/event-monster/frontend/src/app.{js,ts,vue}",
      "C:/Development/event-monster/frontend/src/Error.{js,ts,vue}",
      "C:/Development/event-monster/frontend/src/error.{js,ts,vue}"
    ],
    "extract": {},
    "transform": {}

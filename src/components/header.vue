      ...
      <div class="flex items-center justify-between px-4 py-5 mx-auto max-w-7xl sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
        <div class="hidden dark:block">
          <a href="#" class="flex">
            ...
            <img class="w-auto h-8 sm:h-10" src="../public/EventMonster Logo Web White.png" alt="">
          </a>
        </div>
        <div class="block dark:hidden">
          <a href="#" class="flex">
            <span class="sr-only">Event Monster</span>
            <img class="w-auto h-8 sm:h-10" src="../public/EventMonster Logo Web.png" alt="">
          </a>
        </div>
                      ...
                      <div>
                        ...
                        <ul role="list" class="mt-6 space-y-6">
                          <li v-for="post in blogPosts" :key="post.id" class="flow-root">
                            <a :href="post.href" class="flex p-3 -m-3 rounded-lg hover:bg-gray-100">
                              <div class="flex-shrink-0 hidden sm:block">
                                <img class="object-cover w-32 h-20 rounded-md" :src="post.imageUrl" alt="">
                              </div>
        ...
        <div class="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
          ...
          <div class="px-5 py-6">
            <div class="grid grid-cols-2 gap-4">
              <a href="#" class="text-base font-medium text-gray-900 rounded-md hover:text-gray-700"> Pricing </a>

              <a href="#" class="text-base font-medium text-gray-900 rounded-md hover:text-gray-700"> Docs </a>

              <a href="#" class="text-base font-medium text-gray-900 rounded-md hover:text-gray-700"> Company </a>

              <a href="#" class="text-base font-medium text-gray-900 rounded-md hover:text-gray-700"> Resources </a>

              <a href="#" class="text-base font-medium text-gray-900 rounded-md hover:text-gray-700"> Blog </a>

...
const sendMessage = () => {
  signup.calling(true)
  setTimeout(() => {
    signup.calling(false)
    // feedback.openFeedback(true)
...
<template>
  <div class="flex flex-col">
    <div class="flex flex-col-12">
            ...
            <form class="space-y-6" action="#" method="POST" @submit.prevent="signup.submitForm()">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <a href="/reset-password" for="forgot-password" class="underline underline-offset-4 block text-sm text-gray-900"><small>Forgot password?</small></a>
                </div>
      ...
      <div class="hidden sm:flex flex-col justify-start w-full sm:w-full md:w-1/2 overflow-hidden h-screen">

...
<template>
  <!-- <div class="flex flex-row">
    <div class="basis-1/2 justify-center min-h-full pt-7 pb-12 sm:px-6 lg:px-8 w-full">
      <Sign-Header :show-link="true" text-pre="Have an account?" cta="sign in" url-link="/sign-in" />
  ...
  <div class="px-4 py-8 bg-white sm:rounded-lg sm:px-10 drop-shadow-md  hover:drop-shadow-lg transition duration-550">
    <form class="space-y-6" action="#" method="POST" @submit.prevent="signup.submitForm(true)">
      ...
      <div>
        <label for="name" class="block text-sm font-medium text-gray-700"> Full name <span class="text-indigo-600">*</span></label>
        <div class="mt-1">
      ...
      <div class="flex flex-col items-left justify-between w-full">
        <div class="flex items-left">
          <input id="remember-me" v-model="signup.form.newsletter" name="remember-me" type="checkbox" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
        ...
        <div class="mt-4 w-full">
          <button
            :disabled="signup.disabledForm('sign-up')" :class="{ 'disabled:opacity-75': signup.disabledForm('sign-up') }"
  ...
  <!-- </div> -->
  <!-- </div> -->
  <!-- <div class="basis-1/2 hidden sm:flex flex-col justify-start w-full">
